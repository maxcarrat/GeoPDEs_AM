...
%                * * * * * * * * * * * * * * * * * *
%
% N.B. Refining the coarsened mesh back to the original one should return the
%      same initial values.
%
%
...
% Second level
marked_ref{1} = [];
marked_ref{2} = [9 10 11 12 13 14 15 16];
marked_ref{3} = [];
[hmsh, hspace, Cref] = adaptivity_refine (hmsh, hspace, marked_ref, adaptivity_data);
hmsh_plot_cells (hmsh, 20, 2 );

% assign dofs
v1 = [1 1.0 1.0 1.0 1]';
v2 = [1.3 1.2 1.4 1.1 1.3]';
v3 = v2*0.8;
v4 = v3*1.5;
v5 = v4*1.2;
v6 = v4;
...
v9 = v2*1.5;
v10 =v4;
v11 = [1 1 1.3 1.2 1 1.4 1.3]';

hspace.dofs = cat(1, v1, v11, v3, v4, v5, v6, v7, v8, v9, v10, v2);
figure(3); plot(hspace.dofs);
...
%% Reconstruct original surface with refinement
