...
adaptivity_data.radius = [0.025, 0.005];
...
plot_data.time_steps_to_post_process =linspace(1,n_time_steps,n_time_steps); % [1, 50, 100, 150, 200, 250, 300, 350, 400]; %  
...
plot_data.npoints_y = 51;        %number of points y-direction in post-processing
