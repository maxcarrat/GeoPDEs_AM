...
problem_data.grad_c_diff = @conductivity_der_3D;
...
method_data.nsub_coarse = [10 10 10];        % Number of subdivisions of the coarsest mesh, with respect to the mesh in geometry
...
plot_data.file_name = strcat(problem_output.folder, '/poisson_adaptivity_travelling_heat_source_error3D_%d.vts');
