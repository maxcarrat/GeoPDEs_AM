...
plot_data.time_steps_to_post_process = [1,5,10,15,20];%[1,25,50,75,100,125,150,175,200,250,300,350,400];%linspace(1,n_time_steps,n_time_steps);%
plot_data.file_name = strcat(problem_output.folder, '/poisson_adaptivity_Fachinotti_20_refine_coarse_source_3D_lumped_%d.vts');
plot_data.file_name_mesh = strcat(problem_output.folder, '/poisson_adaptivity_Fachinotti_20_refine_coarse_source_3D_lumped_mesh_%d');
