...
problem_data.initial_temperature = 80;                  %[°C]
...
problem_data.f = @(x,y,path_x,path_y)  3.0 * 3.0 * 5830.0/(pi * 0.00015 * 0.00010 ) * ...
    exp(- 3*(x-path_x).^2/0.00015.^2 - 3*(y-path_y).^2/0.00010.^2 );       % Body Load
...
adaptivity_data.radius = [0.00015, 0.00015];
...
plot_data.time_steps_to_post_process = [1, 3, 5, 7, 10, 15, 20]; %linspace(1,n_time_steps,n_time_steps); % [1, 10, 20, 30, 40, 50, 100, 150, 200, 250, 300, 350, 400]; %      
